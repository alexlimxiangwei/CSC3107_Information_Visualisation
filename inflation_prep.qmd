...
We suspected the COVID-19 pandemic might have affected the inflation rates for the selected categories. Hence, we obtained another set of data from daily reported COVID-19 cases from [World Health Organization](https://data.who.int/dashboards/covid19/data/), which contains the total number of COVID-19 cases reported daily, from Jan 2020 to June 2024.
...
long_data <- pivot_longer(wide_data, cols = -expenditure_category, names_to = "date", values_to = "inflation_rate")
