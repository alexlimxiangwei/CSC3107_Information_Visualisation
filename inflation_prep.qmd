...
long_data <- pivot_longer(filtered_wide_inflation_data, cols = -expenditure_category, names_to = "date", values_to = "inflation_rate")
...
ggplot() +
  # Inflation change heatmap
  geom_tile(data = long_data, aes(x = date, y = y_value, fill = inflation_rate), color = "grey90") +
  theme_minimal() +
  scale_fill_distiller(palette = "RdYlBu") +
