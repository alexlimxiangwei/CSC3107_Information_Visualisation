...
-   **Data Source:** The data used for this project is based on the visualization data from @Joella_Carman and @Nigel_Chiwaya, featured on @NBC_News. They utilized the information from the Bureau of Labor Statistics and Energy Information Administration data to depict year-over-year inflation for major categories of goods.
